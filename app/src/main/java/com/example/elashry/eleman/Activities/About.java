...
public class About extends AppCompatActivity {
    ...
    public void loadAbout() {
        ...
        AboutBuilder builder = AboutBuilder.with(this)
                ...
                .addYoutubeChannelLink("ww.semicolonsoft.com")
                .addDribbbleLink("ww.semicolonsoft.com")
                .addLinkedInLink("ww.semicolonsoft.com")
                .addEmailLink("ww.semicolonsoft.com")
                .addWhatsappLink("مركز الايمان", "01062737363")
                .addSkypeLink("semicolon")
                .addGoogleLink("semicolon")
                .addAndroidLink("semicolon")
                .addWebsiteLink("www.semicolonsoft.com")
                .addFiveStarsAction()
                .addMoreFromMeAction("semicolon")
                .setVersionNameAsAppSubTitle()
                .addShareAction("Semi Colon")
                .addUpdateAction()
