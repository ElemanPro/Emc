package com.semicolon.emcmisir.Fragment;
...
import com.semicolon.emcmisir.Activities.Check_Internet_connection;
import com.semicolon.emcmisir.Adapter.Product_Adapter;
 ...
 */
public class Televtion extends Fragment {
    ...
    private void init_View(View view) {
        ...
        mrRecyclerView = (RecyclerView) view.findViewById(R.id.tv_recyView);
        mrRecyclerView.setLayoutManager(new LinearLayoutManager(mContext));
        mrRecyclerView.setVisibility(View.GONE);
        prog_bar          = (ProgressBar) view.findViewById(R.id.t_progBar);
