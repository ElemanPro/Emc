...
public class Order extends AppCompatActivity {
    ...
    public void registerOrder(View view) {
        ...
        {
            mdialog.setMessage(getString(R.string.ch_cn));
            mdialog.show();
        }
        ...
        {
            mdialog.setMessage(getString(R.string.ch_qu));
            mdialog.show();
        }
        else
        {
            ...
            else
            {
                ...
                mdialog.setNegativeButton(getString(R.string.cancel_txt), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(Order.this, getString(R.string.cancel_txt), Toast.LENGTH_SHORT).show();
                    }
                });
                mdialog.show();
            }
