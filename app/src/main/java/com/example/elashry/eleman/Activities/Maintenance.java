...
public class Maintenance extends AppCompatActivity {
    Button b1;
    EditText cname,cphone,caddress,dtype, dateorder ,marka;
    Calendar myCalendar;
    Spinner spinner;
...
//        });
    ...
    public void registerOrder(View view) {
        if(   cname.getText().toString().isEmpty()&&cphone.getText().toString().isEmpty()&&
                ...
                dateorder.getText().toString().isEmpty()&&marka.getText().toString().isEmpty())
        {
            ...
            StringRequest strReq = new StringRequest(Request.Method.POST,
                ...
                public void onResponse(String response) {
                    ...
                    Toast.makeText(getApplicationContext(),
                            "Your messege sent", Toast.LENGTH_LONG).show();
                }
