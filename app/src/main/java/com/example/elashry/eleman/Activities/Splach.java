...
public class Splach extends AwesomeSplash {
   ...
   /* you don't have to override every property */
        ...
        //Customize Logo
        configSplash.setLogoSplash(R.drawable.semc); //or any other drawable
        ...
        configSplash.setPathSplashStrokeColor(R.color.background_color); //any color you want form colors.xml
        configSplash.setAnimPathFillingDuration(3000);
        configSplash.setPathSplashFillColor(R.color.background_color); //path object filling color
